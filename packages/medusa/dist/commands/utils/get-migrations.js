...
exports.default = (function (directory, featureFlagRouter) { return __awaiter(void 0, void 0, void 0, function () {
    var migrationDirs, configModule, plugins, resolved, coreMigrations, resolved_1, resolved_1_1, p, exists;
    var e_1, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                plugins = configModule === null || configModule === void 0 ? void 0 : configModule.plugins;
                resolved = plugins === null || plugins === void 0 ? void 0 : plugins.map(function (plugin) {
                ...
                if (!plugins) {
                    logger_1.default.warn("Unable to load plugins");
                }
                resolved.push({
