...
var t = function (_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var resolvedPath, configModule, hostConfig, featureFlagRouter, dbType, migrationDirs, connection, app, container, manager, storeService, userService, regionService, productService, productVariantService, shippingOptionService, shippingProfileService;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!(migrate && dbType !== "sqlite")) return [3 /*break*/, 6];
                    return [4 /*yield*/, (0, get_migrations_1.default)(directory, featureFlagRouter)];
                case 2:
                    migrationDirs = _b.sent();
                    return [4 /*yield*/, (0, typeorm_1.createConnection)(__assign(__assign({ type: configModule.projectConfig.database_type }, hostConfig), { extra: configModule.projectConfig.database_extra || {}, migrations: migrationDirs, logging: true }))];
                case 3:
                    connection = _b.sent();
